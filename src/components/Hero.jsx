...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of expert uses a methodology to identify the credit cards most likely to fit your need. We examine annual percentage rates, annual fee.</p>
    </div>

    <div className={`flex-1 flex ${styles.flexCenter} md:mw-0 my-10 relative`}>
